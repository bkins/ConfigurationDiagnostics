...
internal sealed class DetailedDumpStrategy : IConfigurationDumpStrategy
{
    ...
    public DetailedDumpStrategy( IConfigurationDumpStrategy providerDumpStrategy
                    ...
                    , ConfigurationDumpOptions options )
    {
        ...
        _providerDumpStrategy.Dump(configurationRoot
                                 , writer
                                 , options);
        _treeDumpStrategy.Dump(configurationRoot
                             , writer
                             , options);
        _overridesDumpStrategy.Dump(configurationRoot
                                  , writer
                                  , options);
    }
}