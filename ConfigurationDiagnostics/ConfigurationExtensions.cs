...
public static class ConfigurationExtensions
{
    ...
    public static void DumpToConsole( this IConfiguration   configuration
    ...
    {
        ConfigurationDumper.Dump(configuration: configuration
                               , writer: Console.Out
                               , options: options);
    }

    /// <summary>Writes the configuration dump to an arbitrary <see cref="TextWriter" />, e.g. a log sink or file stream.</summary>
    public static void DumpToWriter( this IConfiguration       configuration
                                   , TextWriter                writer
                                   , ConfigurationDumpOptions? options = null )
    {
        ConfigurationDumper.Dump(configuration: configuration
                               , writer: writer
                               , options: options ?? new ConfigurationDumpOptions());
    }
